...
`alpaca-trade-api-python` is a [python library](https://www.interviewbit.com/blog/python-libraries/) for the [Alpaca Commission Free Trading API](https://alpaca.markets).
